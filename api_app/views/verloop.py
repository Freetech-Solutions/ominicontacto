...
class VerloopWebhookView(APIView):
    ...
    del contacto en la campaña correspondiente. Si ya existe una AgendaContacto
    para el contacto y la campaña, solo concatena el call_summary a las
    observaciones de esa agenda y no publica comandos al ACD. Si no hay agenda
    previa y la opción aplicada coincide con la configurada para fin de gestión
    del bot, publica voicebot_transfer_proceed en Redis para que el ACD
    continúe la transferencia pendiente tras el REFER.
    """
