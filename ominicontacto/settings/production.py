...
assert ALLOWED_HOSTS, "Falta definir setting para ALLOWED_HOSTS (DJANGO_ALLOWED_HOSTS)"
assert '*' not in ALLOWED_HOSTS, "ALLOWED_HOSTS no debe contener '*' en producción"
