...
class Click2CallOriginator(object):
    ...
    def _submit_gearman_job(self, payload):
        ...
        if not self.gearman_client:
            error = _("Cliente Gearman no está disponible. Verifique la configuración de GEARMAN_JOB_SERVERS")  # noqa: E501
            logger.error(error)
            return error
    ...
    def call_originate(self, agente, campana_id, tipo_campana,
        ...
        try:
            ...
            logger.info(
                "Click2Call encolado exitosamente - agente: {0}, campana: {1}, telefono: {2}".format(  # noqa: E501
            ...
            error = _("Error inesperado al realizar click2call: {0} - contacto: {1}".format(e, telefono))  # noqa: E501
            logger.exception(error)
            return error
    ...
    def call_agent(self, agente_origen, agente_destino):
        ...
        try:
            ...
            logger.info(
                "Click2Call agent2agent encolado exitosamente - agente_origen: {0}, agente_destino: {1}".format(  # noqa: E501
            ...
            error = _("Error inesperado al realizar llamada agent2agent: {0} - agente_origen: {1} - agente_destino: {2}".format(  # noqa: E501
    ...
    def _call_without_campaign(self, agente, tipo_destino, numero):
        ...
        try:
            ...
            error = _("Error inesperado al realizar llamada fuera de campaña: {0} - tipo_destino: {1} - numero: {2}".format(  # noqa: E501
