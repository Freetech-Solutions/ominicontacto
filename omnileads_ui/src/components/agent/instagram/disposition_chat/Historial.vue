<template>
  <div class="card">
    <DataTable
      :value="agtInstagramDispositionChatHistory"
...
import {
    FORM_TYPES
} from '@/globals/agent/instagram/disposition';
import {
    CAMPAIGN_TYPES
} from '@/globals';
...
export default {
    ...
    computed: {
        ...mapState(['agtInstagramDispositionChatHistory'])
    },
    methods: {
        clearFilter () {
            this.initFilters();
    ...
    watch: {
        agtInstagramDispositionChatHistory: {
            handler () {},
            deep: true,
            immediate: true
        }
