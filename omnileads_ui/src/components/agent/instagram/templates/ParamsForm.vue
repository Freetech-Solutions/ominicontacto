...
export default {
    ...
    methods: {
        ...mapActions([
            'agtInstagramConversationSendTemplateMessage',
            'agtInstagramConversationReactiveExpiredConversation'
        ]),
        initializeData () {
            this.initFormData();
        ...
        async send () {
            try {
                ...
                console.log('-------------', reqData);
                if (this.onlyInstagramTemplates) {
                    result = await this.agtInstagramConversationReactiveExpiredConversation(
                        reqData
                    );
                } else {
