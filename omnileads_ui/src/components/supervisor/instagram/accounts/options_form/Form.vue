...
import { DESTINATION_OPTION_TYPES } from '@/globals/supervisor/instagram/account';
...
export default {
    ...
    computed: {
        ...mapState([
            ...
            'supInstagramAccountOptionForm',
            'supInstagramAccountDestinationMenuOptions',
            'supInstagramAccountTemplates'
        ])
    },
    methods: {
        ...mapActions([
            'createInstagramAccountOption',
            'updateInstagramAccountOption',
        ...
        initFormData () {
            this.form.id = this.supInstagramAccountOptionForm ? this.supInstagramAccountOptionForm.id : null;
            this.form.index = this.supInstagramAccountOptionForm ? this.supInstagramAccountOptionForm.index : null;
            this.form.value = this.supInstagramAccountOptionForm ? this.supInstagramAccountOptionForm.value : null;
            this.form.description = this.supInstagramAccountOptionForm ? this.supInstagramAccountOptionForm.description : null;
            this.form.type_option = this.supInstagramAccountOptionForm ? this.supInstagramAccountOptionForm.type_option : null;
            this.form.destination = this.supInstagramAccountOptionForm ? this.supInstagramAccountOptionForm.destination : null;
            this.form.destination_name = this.supInstagramAccountOptionForm ? this.supInstagramAccountOptionForm.destination_name : null;
            this.findDestinationOptions();
            this.findDuplicated();
            // this.findMsgTemplateOptions();
        },
        findDuplicated () {
            const duplicated = this.supInstagramAccountOptions.find(
                (option) =>
        ...
        findDestinationOptions () {
            this.destinationmenuoptions = this.supInstagramAccount.destination.data.filter(item => item.id_tmp !== this.menuId);
        },
        save (isFormValid) {
            this.submitted = true;
            if (!isFormValid) {
            ...
            if (this.formToCreate) {
                this.createInstagramAccountOption({
                    data: this.form,
                    menuId: this.menuId
                });
            } else {
                const id = this.form.id ? this.form.id : this.form.index;
                this.updateInstagramAccountOption({
                    id: id,
                    data: this.form,
                    menuId: this.menuId
                });
