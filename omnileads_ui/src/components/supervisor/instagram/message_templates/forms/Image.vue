...
export default {
    ...
    computed: {
        ...mapState(['supInstagramAccountTemplateFormFields'])
    },
    methods: {
        initializeData () {
            this.initFormData();
        ...
        initFormData () {
            if (this.supInstagramAccountTemplateFormFields) {
                this.form = {
                    type: 'image',
                    originalUrl: this.supInstagramAccountTemplateFormFields.originalUrl,
                    previewUrl: this.supInstagramAccountTemplateFormFields.previewUrl,
                    caption: this.supInstagramAccountTemplateFormFields.caption
                };
            }
        },
    ...
    watch: {
        supInstagramAccountTemplateFormFields: {
            handler () {
                this.initFormData();
            },
            deep: true,
