...
export default {
    ...
    computed: {
        ...mapState(['supInstagramReportCampaignAgents'])
    },
    async created () {
        await this.search();
    },
    methods: {
        ...mapActions(['initSupInstagramReportCampaignConversations']),
        cleanFilters () {
        ...
        async search () {
            ...
            await this.initSupInstagramReportCampaignConversations({
    ...
    watch: {
        supInstagramReportCampaignAgents: {
            handler () {
                this.agents = [
                    this.agents[0],
                    ...this.supInstagramReportCampaignAgents
                ];
            },
            deep: true,
            immediate: true
