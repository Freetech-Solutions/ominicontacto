export default {
    ...
    line: 'Linea | Lineas',
    last_conversation: 'Conversación anterior | Conversaciones anteriores',
    whatsapp: {
        title: 'Whatsapp',
    ...
    use: 'Usar',
    disposition: 'Calificación | Calificaciones',
    was_closed_by_system: 'Fue cerrado por el sistema',
    // ----------------
    // --- weekdays ---
    // ----------------
    monday: 'Lunes',
