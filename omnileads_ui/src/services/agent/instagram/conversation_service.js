import URLS from '@/api_urls/agent/instagram/conversation_urls';
import { BaseService, HTTP } from '@/services/base_service';

export default class InstagramConversationService extends BaseService {
    constructor () {
        super(URLS, 'Instagram <Conversation>');
    }
    ...
    async getAgentChatsList () {
        try {
            this.initPayload();
            console.log('Fetching Instagram Agent Chats List>>>>>>>');
