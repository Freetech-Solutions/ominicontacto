import URLS from '@/api_urls/agent/instagram/disposition_chat_urls';
import { BaseService, HTTP } from '@/services/base_service';

class InstagramDispositionChatService extends BaseService {
    constructor () {
        super(URLS, 'Instagram < Disposition Chat >');
    }
...
export default new InstagramDispositionChatService();
