import URLS from '@/api_urls/agent/instagram/transfer_urls';
import { BaseService, HTTP } from '@/services/base_service';

export default class InstagramTransferChatService extends BaseService {
    constructor () {
        super(URLS, 'Instagram < Transfer Chat >');
    }
