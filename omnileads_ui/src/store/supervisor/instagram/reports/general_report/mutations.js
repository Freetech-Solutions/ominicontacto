export default {
    initSupInstagramReportGeneral (state, data = null) {
        state.supInstagramReportGeneral = {
    ...
    initSupInstagramReportGeneralColors (state, colors = null) {
        state.supInstagramReportGeneralColors = {
