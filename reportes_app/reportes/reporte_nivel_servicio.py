...
class ReporteNivelServicio(object):
    ...
    def _calcular_estadisticas_generales(self, llamadas):
        ...
        self.estadisticas = {
            ...
            'tiempo_promedio_espera': round(tiempo_promedio_espera, 2) if tiempo_promedio_espera else None,  # noqa: E501
            'tiempo_promedio_abandono': round(tiempo_promedio_abandono, 2) if tiempo_promedio_abandono else None,  # noqa: E501
    ...
    def _calcular_kpi_eficiencia(self, llamadas_contestadas):
        ...
        tiempo_total_segundos = (
            tiempo_conversacion_segundos + tiempo_hold_segundos + tiempo_acw_segundos
        )
        tiempo_total_minutos = tiempo_total_segundos / 60.0

        # Promedio por llamada
        total_llamadas = llamadas_contestadas.count()
        promedio_por_llamada_segundos = (
            tiempo_total_segundos / total_llamadas if total_llamadas > 0 else 0
        )
    ...
    def _calcular_tiempo_acw_total(self, llamadas_contestadas):
        ...
        for llamada_info in llamadas_info:
            ...
            # Buscar eventos PAUSEALL con pausa_id='0' (ACW) después de la finalización de la
            # llamada
