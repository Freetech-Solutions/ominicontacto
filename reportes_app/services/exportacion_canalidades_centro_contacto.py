...
"""
Servicio para exportar la tabla "Canalidades por campaña" del reporte
...
PREFIJO_ARCHIVO = 'canalidades_por_campana'
...
def generar_csv_canalidades_centro_contacto(
    key_task,
    task_id,
    start_date=None,
    end_date=None,
    ...
    """
    Genera el archivo CSV de Canalidades por campaña (Ingresos) y publica
    progreso en Redis (0 y 100). key_task debe ser OML:STATUS_CSV_REPORT:CANALIDADES_CC:cc:{task_id}.  # noqa: E501
    """
    ...
    try:
        ...
        logger.warning("Redis publish(0) canalidades CC: %s", e)
    ...
    try:
        ...
        logger.exception("Error obteniendo canalidades por campaña: %s", e)
        try:
    ...
    try:
        ...
        logger.warning("Redis publish(100) canalidades CC: %s", e)


def obtener_url_descarga_canalidades(task_id):
    """
