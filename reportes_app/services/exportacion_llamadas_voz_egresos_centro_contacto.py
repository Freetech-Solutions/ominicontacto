...
"""
Servicio para exportar la tabla "Distribución de llamadas" (Egresos/Voz/Campañas)
...
def generar_csv_llamadas_voz_egresos_centro_contacto(
    ...
    """
    Genera el archivo CSV de Distribución de llamadas por campaña (Egresos) y publica
    progreso en Redis (0 y 100). key_task debe ser OML:STATUS_CSV_REPORT:LLAMADAS_VOZ_EGRESOS_CC:cc:{task_id}.  # noqa: E501
    """
