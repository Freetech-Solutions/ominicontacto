...
def generar_csv_whatsapp_mensajes_por_campana_egresos_centro_contacto(
    ...
    progreso en Redis (0 y 100). key_task debe ser OML:STATUS_CSV_REPORT:WA_MSG_CAMPANA_EGRESOS_CC:cc:{task_id}.  # noqa: E501
    """
    ...
    with open(ruta, 'w', newline='', encoding='utf-8') as f:
        ...
        if rows:
            ...
            pct_resp = round(100.0 * total_respondidos / total_enviados,
                             1) if total_enviados else None
            pct_no_resp = round(100.0 * total_no_respondidos /
                                total_enviados, 1) if total_enviados else None
            writer.writerow([
                _('Total'),
