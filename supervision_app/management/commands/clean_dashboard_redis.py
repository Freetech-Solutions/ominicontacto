    ...
    try:
        ...
        if keys_to_delete:
            ...
            try:
                ...
                logger.info(
                    f"Pipeline ejecutado: {total_deleted} keys eliminadas de {len(unique_keys)} intentadas")  # noqa: E501
            except Exception as e:
...
class Command(BaseCommand):
    help = (
        'Ejecuta un scheduler AppScheduler para limpiar a diario '
        'las keys Redis DB 2 del dashboard Panel'
    )
